...
class TestCases(unittest.TestCase):
  ...
  def test_schema_from_data(self):
    ...
    schema1 = gcp.bigquery.Schema.from_data(variant1)
    schema2 = gcp.bigquery.Schema.from_data(variant2)
    ...
    self.assertEquals(schema_master, schema1, 'schema inferred from list with from_data')
    self.assertEquals(schema_master, schema2, 'schema inferred from dict with from_data')
